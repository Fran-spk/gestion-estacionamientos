...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TarifaServicioTicketBase", b =>
                {
                    b.Property<int>("TarifasAdicionalesTarifaServicioId")
                        .HasColumnType("int");

                    b.Property<int>("TicketsTicketBaseId")
                        .HasColumnType("int");

                    b.HasKey("TarifasAdicionalesTarifaServicioId", "TicketsTicketBaseId");

                    b.HasIndex("TicketsTicketBaseId");

                    b.ToTable("TarifaServicioTicketBase");
                });
            ...
            modelBuilder.Entity("TarifaServicioTicketBase", b =>
                {
                    b.HasOne("MODELO.TarifaServicio", null)
                        .WithMany()
                        .HasForeignKey("TarifasAdicionalesTarifaServicioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MODELO.TicketBase", null)
                        .WithMany()
                        .HasForeignKey("TicketsTicketBaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
