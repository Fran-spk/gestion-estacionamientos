    ...
    public partial class v1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ServicioVehiculoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TipoServicioId = table.Column<int>(type: "int", nullable: false),
                    TipoVehiculoId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiciosVehiculos", x => x.ServicioVehiculoId);
                    table.ForeignKey(
                        name: "FK_ServiciosVehiculos_Tipo_Servicios_TipoServicioId",
                        column: x => x.TipoServicioId,
                        principalTable: "Tipo_Servicios",
                        principalColumn: "TipoServicioId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiciosVehiculos_Tipos_Vehiculos_TipoVehiculoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tarifa_Servicios_ServiciosVehiculos_ServicioVehiculoId",
                        column: x => x.ServicioVehiculoId,
                        principalTable: "ServiciosVehiculos",
                        principalColumn: "ServicioVehiculoId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TicketBaseId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EstacionamientoPago = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "AuditoriaTickets",
                columns: table => new
                {
                    AuditoriaTicketId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TicketBaseId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuditoriaTickets", x => x.AuditoriaTicketId);
                    table.ForeignKey(
                        name: "FK_AuditoriaTickets_Tickets_Base_TicketBaseId",
                        column: x => x.TicketBaseId,
                        principalTable: "Tickets_Base",
                        principalColumn: "TicketBaseId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AuditoriaTickets_Usuarios_UsuarioId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PagoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MetodoDePagoId = table.Column<int>(type: "int", nullable: false),
                    TicketBaseId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "ServiciosConsumidos",
                columns: table => new
                {
                    ServicioConsumidoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TicketBaseId = table.Column<int>(type: "int", nullable: false),
                    TicketDiarioTicketBaseId = table.Column<int>(type: "int", nullable: true),
                    PlanPERID = table.Column<int>(name: "PlanPER_ID", type: "int", nullable: true),
                    TarifaServicioId = table.Column<int>(type: "int", nullable: false),
                    Pagado = table.Column<bool>(type: "bit", nullable: false),
                    Anulado = table.Column<bool>(type: "bit", nullable: false),
                    FechaHoraAsignado = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiciosConsumidos", x => x.ServicioConsumidoId);
                    table.ForeignKey(
                        name: "FK_ServiciosConsumidos_Planes_PlanPER_ID",
                        column: x => x.PlanPERID,
                        principalTable: "Planes",
                        principalColumn: "PER_ID");
                    table.ForeignKey(
                        name: "FK_ServiciosConsumidos_Tarifa_Servicios_TarifaServicioId",
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.TicketDiarioTicketBaseId,
                        principalTable: "Tickets_Base",
                        principalColumn: "TicketBaseId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ServicioConsumidoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditoriaTickets_TicketBaseId",
                table: "AuditoriaTickets",
                column: "TicketBaseId");

            migrationBuilder.CreateIndex(
                name: "IX_AuditoriaTickets_UsuarioId",
                table: "AuditoriaTickets",
                column: "UsuarioId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PagoDetalles_ServicioConsumidoId",
                table: "PagoDetalles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiciosConsumidos_TarifaServicioId",
                table: "ServiciosConsumidos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiciosVehiculos_TipoServicioId_ServicioVehiculoId",
                table: "ServiciosVehiculos",
                columns: new[] { "TipoServicioId", "ServicioVehiculoId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ServiciosVehiculos_TipoVehiculoId",
                table: "ServiciosVehiculos",
                column: "TipoVehiculoId");

            migrationBuilder.CreateIndex(
                name: "IX_Tarifa_Servicios_ServicioVehiculoId",
